package com.roy.turbo.launcher.backup;
...
//        public static final Journal EMPTY_ARRAY[] = {};
        ...
        public com.roy.turbo.launcher.backup.BackupProtos.Key[] key = com.roy.turbo.launcher.backup.BackupProtos.Key.EMPTY_ARRAY;
        ...
        public Journal clear() {
            ...
            bytes = 0L;
            rows = 0;
            key = com.roy.turbo.launcher.backup.BackupProtos.Key.EMPTY_ARRAY;
            cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
            ...
            for (com.roy.turbo.launcher.backup.BackupProtos.Key element : this.key) {
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 42: {
                        ...
                        com.roy.turbo.launcher.backup.BackupProtos.Key[] newArray = new com.roy.turbo.launcher.backup.BackupProtos.Key[i + arrayLength];
                        System.arraycopy(this.key, 0, newArray, 0, i);
                        this.key = newArray;
                        for (; i < this.key.length - 1; i++) {
                            this.key[i] = new com.roy.turbo.launcher.backup.BackupProtos.Key();
...
//        public static final Widget EMPTY_ARRAY[] = {};
        ...
        public com.roy.turbo.launcher.backup.BackupProtos.Resource icon = null;

        // optional .launcher_backup.Resource preview = 5;
        public com.roy.turbo.launcher.backup.BackupProtos.Resource preview = null;
        ...
        public Widget mergeFrom(
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 34: {
                        this.icon = new com.roy.turbo.launcher.backup.BackupProtos.Resource();
                        input.readMessage(this.icon);
                        break;
                    }
                    case 42: {
                        this.preview = new com.roy.turbo.launcher.backup.BackupProtos.Resource();
